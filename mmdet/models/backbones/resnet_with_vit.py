...
class ResNetWithVit(ResNet):
    ...
    This class ResNetWithVit provide the first version for merging the feature.
    In this version, it merge one or more ViT feature level to respective ResNet feature level'''
    def __init__(self, 
                 depth,
                 in_channels=3,
                 stem_channels=None,
